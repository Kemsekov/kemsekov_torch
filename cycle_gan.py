...
from kemsekov_torch.common_modules import GradientReversal, get_optim_groups
import torch
...
def train_cycle_gan(
    ...
    loss_lambda:
        ...
        If your training diverges into some nonsense as time passes, try to use like `0.25` or `0.5` value for this thing.
