...
class VQVAE2(nn.Module):
    ...
    def __init__(self,encoder,decoder,embedding_dim,codebook_size=[256,128,128],embedding_scale=1):
        ...
        """
        super().__init__()
        self.quantizer_low = VectorQuantizer(embedding_dim,codebook_size[0],0.99,1e-5,embedding_scale)
        self.quantizer_middle = VectorQuantizer(embedding_dim,codebook_size[1],0.99,1e-5,embedding_scale)
        self.quantizer_high = VectorQuantizer(embedding_dim,codebook_size[2],0.99,1e-5,embedding_scale)
